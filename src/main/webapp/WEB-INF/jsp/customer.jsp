...
<%@ taglib prefix="harry" uri="http://harry.com/common/"%>
<%
...
<body>
	...
	<div id="wrapper">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.html">BOOT客户管理系统 v3.0</a>
		</div>
		<!-- /.navbar-header -->
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<harry:page url="${pageContext.request.contextPath }/customer/list.action" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
